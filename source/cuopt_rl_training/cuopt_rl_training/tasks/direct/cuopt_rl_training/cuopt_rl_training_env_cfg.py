...
from cuopt_rl_training.robots.jetbot import JETBOT_CONFIG
...
class CuoptRlTrainingEnvCfg(DirectRLEnvCfg):
    # paths
    scene_usd_path: str = "/mnt/hdd/isaac/Isaac-Object/Warehouse_cuopt.usd"
    nova_carter_usd_path: str = "/mnt/hdd/isaac/Isaac-Object/Robot/Collected_NVIDIA/nova_carter.usd"
    iw_hub_usd_path: str = "/mnt/hdd/isaac/Isaac-Object/Robot/Collected_Idealworks/iw_hub.usd"
    jetbot_usd_path: str = "/mnt/hdd/isaac/Isaac-Object/Robot/Collected_NVIDIA/jetbot.usd"
    # env
    decimation: int = 2
    ...
    robot3_cfg = JETBOT_CONFIG.replace(prim_path="/World/envs/env_0.*/Robots/Robot3")
