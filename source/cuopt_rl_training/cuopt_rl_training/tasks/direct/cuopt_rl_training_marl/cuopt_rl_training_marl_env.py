...
from .cuopt_rl_training_marl_env_cfg import CuoptRlTrainingMarlEnvCfg


class CuoptRlTrainingMarlEnv(DirectMARLEnv):
    cfg: CuoptRlTrainingMarlEnvCfg

    def __init__(self, cfg: CuoptRlTrainingMarlEnvCfg, render_mode: str | None = None, **kwargs):
